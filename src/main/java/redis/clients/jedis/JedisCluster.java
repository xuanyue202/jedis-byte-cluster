...
public class JedisCluster extends BinaryJedisCluster implements BasicCommands, JedisCommands, Closeable,
	...
	@Override
	public Object evalsha(final String sha1, final List<String> keys,
			final List<String> args) {
		return new JedisClusterCommand<Object>(connectionHandler, timeout,
				maxRedirections) {
			@Override
