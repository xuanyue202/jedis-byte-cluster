...
public class HostAndPortUtil {
	...
	clusterHostAndPortList.add(new HostAndPort("10.0.0.147", 7379));
	clusterHostAndPortList.add(new HostAndPort("10.0.0.147", 7380));
	clusterHostAndPortList.add(new HostAndPort("10.0.0.147", 7381));
	clusterHostAndPortList.add(new HostAndPort("10.0.0.147", 7382));
	clusterHostAndPortList.add(new HostAndPort("10.0.0.147", 7383));
	clusterHostAndPortList.add(new HostAndPort("10.0.0.147", 7384));
